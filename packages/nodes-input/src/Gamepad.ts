...
export default function GamepadInput() {
  ...
  this.addOutput("button_pressed", BuiltInSlotType.EVENT);
...
GamepadInput.prototype.onGetOutputs = function () {
  return [
    ...
    ["start_button", "number"],
    ["back_button", "number"],
    ["a_button_event", BuiltInSlotType.EVENT],
    ["b_button_event", BuiltInSlotType.EVENT],
    ["x_button_event", BuiltInSlotType.EVENT],
    ["y_button_event", BuiltInSlotType.EVENT],
    ["lb_button_event", BuiltInSlotType.EVENT],
    ["rb_button_event", BuiltInSlotType.EVENT],
    ["ls_button_event", BuiltInSlotType.EVENT],
    ["rs_button_event", BuiltInSlotType.EVENT],
    ["start_button_event", BuiltInSlotType.EVENT],
    ["back_button_event", BuiltInSlotType.EVENT],
    ["hat_left", "number"],
    ["hat_right", "number"],
    ["hat_up", "number"],
    ["hat_down", "number"],
    ["hat", "number"],
    ["button_pressed", BuiltInSlotType.EVENT],
  ];
};
