  ...
  },
  {
    ...
    wave: function (i, sampleRate, frequency) {
      ...
      if (valueTable.length <= Math.ceil(period)) {
        ...
        valueTable[playVal] =
          (valueTable[playVal >= valueTable.length - 1 ? 0 : playVal + 1] + valueTable[playVal]) * 0.5;
...
// export const AudioSynth = AudioSynth;

export default { Synth, AudioSynth, AudioSynthInstrument };
