...
class LiteGraph {
  ...
  registered_node_types: any = {}; // nodetypes by string
  ...
  unregisterNodeType(type: string) {
    let baseClass = type.constructor === String ? this.registered_node_types[type] : type;
    if (!baseClass) throw "node type not found: " + type;
    delete this.registered_node_types[baseClass.type];
