const install = LiteGraph => {
  ...
  LiteGraph.registerNodeType({
    type: "features/widgets", class: TestWidgetsNode
  });
  LiteGraph.registerNodeType({ type: "features/shape", class: TestSpecialNode});
  LiteGraph.registerNodeType({ type: "features/slots", class: TestSlotsNode});
  LiteGraph.registerNodeType({ type: "features/properties_editor", class: TestPropertyEditorsNode});
};
